              ...
              {nftData.history.map((event, idx) => (
                <div key={idx}>
                  ...
                  {event.type === "Transfer" ? (
                    ...
                    <p>
                      Seller: {event.seller}, Price: {event.price} ETH
                    </p>
                  )}
...
const TransactionExplorer = () => {
  ...
  const searchTransaction = async () => {
    ...
    try {
      ...
      setError(
        error.message || "Error fetching transaction data. Please try again."
      );
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        {isLoading && (
          <div className="text-center">Loading transaction information...</div>
        )}
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p
                  className={`text-${
                    txData.status === "Success" ? "green" : "red"
                  }-500`}
                >
                  {txData.status}
                </p>
